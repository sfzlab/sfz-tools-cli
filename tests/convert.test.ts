...
// test('Convert syntax directory to json', async () => {
//   const output: CliOutput = await cli(`convert "./test/syntax/**/*.sfz" --js`);
//   expect(output.exitCode).toBe(0);
//   expect(output.stdout).toMatchSnapshot();
// });

// test('Convert syntax directory to xml', async () => {
//   const output: CliOutput = await cli(`convert "./test/syntax/**/*.sfz" --xml`);
//   expect(output.exitCode).toBe(0);
//   expect(output.stdout).toMatchSnapshot();
// });
